      ...
      <div className="p-8 bg-gray-50 border-b-2 border-black">
        ...
        <div className="relative mb-8 pt-4">
          ...
          >
            ...
            {/* Playhead */}
            <div 
              className="absolute h-6 w-1 bg-black rounded-full -ml-0.5 z-10 pointer-events-none transition-all duration-100"
          ...
          <AnimatePresence>
            {hoveredMarker && (
              <motion.div 
                ...
                className="absolute -top-12 left-1/2 -translate-x-1/2 text-xs font-black bg-black text-white border-2 border-black shadow-[4px_4px_0px_#000] px-4 py-2 rounded-lg whitespace-nowrap z-50 pointer-events-none"
              >
        ...
        <div className="flex items-center justify-between">
          ...
          <div>
             <button 
               ...
               className="bg-white border-4 border-black text-black hover:bg-black hover:text-white font-black px-10 py-3 rounded-2xl uppercase tracking-[0.2em] text-sm transition-all shadow-[6px_6px_0px_#000] active:translate-x-1 active:translate-y-1 active:shadow-none"
             >
               NOTE
             </button>
          </div>
      ...
      <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-12 bg-white">
        ...
        <div className="flex flex-col border-2 border-black rounded-3xl p-8 bg-gray-50 shadow-[6px_6px_0px_#000] overflow-hidden h-[450px]">
          ...
          <div className="mb-8 flex gap-4">
             <div className="w-20 h-12 rounded-xl bg-black text-white font-black text-xs flex items-center justify-center border-2 border-black shrink-0 shadow-[4px_4px_0px_#000]">
          ...
          <div className="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-thin">
            {loadingRevisions ? (
               ...
               sortedRevisions.map((rev, idx) => (
                  <div key={rev.id || idx} className="flex items-start gap-6 group border-b border-black/10 pb-4 last:border-0 hover:bg-black/5 p-2 rounded-xl transition-all">
                     <button 
                       onClick={() => handleSeek(rev.timestamp)}
                       className="text-xs font-black text-white bg-black border-2 border-black px-3 py-1 rounded-lg hover:bg-red-600 hover:border-red-600 transition-all shadow-[3px_3px_0px_rgba(0,0,0,0.2)]"
                     >

...
import { Disc3, ArrowRight, Mail, Lock } from 'lucide-react';
      ...
      >
        <div className="perona-card p-10 flex flex-col bg-[#111111] border-white/5 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-display uppercase tracking-tight text-white mb-2">ACCESS TERMINAL.</h1>
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/20 text-center">Protocol V3.0 Authentication</p>
          </div>
          ...
          <p className="mt-10 text-center text-[10px] font-black uppercase tracking-[0.3em] text-white/20">
            ESTABLISH NEW ID? <Link to="/register" className="text-[#EF4444] hover:text-white transition-colors ml-1">CREATE ACCOUNT</Link>
          </p>
        </div>
      </motion.div>
    </div>
